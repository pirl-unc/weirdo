...
def train_remote(
    ...
    scaler_max_rows: int = 0,
    train_max_rows_per_epoch: int = 0,
    epoch_shuffle: bool = True,
    epoch_shuffle_max_skip_rows: int = 0,
    shuffle_in_batch: bool = True,
    parallel_workers: int = 1,
    parallel_chunksize: int = 256,
    ...
    if max_samples <= 0:
        ...
        scorer.train_streaming(
            ...
            scaler_max_rows=scaler_max_rows,
            train_max_rows_per_epoch=train_max_rows_per_epoch,
            epoch_shuffle=epoch_shuffle,
            epoch_shuffle_max_skip_rows=epoch_shuffle_max_skip_rows,
            shuffle_in_batch=shuffle_in_batch,
    ...
    metadata = {
        ...
        "scaler_rows": scorer._metadata.get("scaler_rows"),
        ...
        "epoch_rows": scorer._metadata.get("epoch_rows"),
        "epoch_skip_rows": scorer._metadata.get("epoch_skip_rows"),
